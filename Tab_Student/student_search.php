<?php  
    ...
    $sql = $mysqli->query("
        SELECT us.User_ID, us.SR_Code, CONCAT(u.Lastname, ' ', u.Firstname) AS Name, u.Gender, p.Program_Code, c.Track 
        FROM user u
            INNER JOIN user_student us ON u.User_ID = us.User_ID 
            INNER JOIN curriculum c ON us.Curriculum_ID = c.Curriculum_ID 
            INNER JOIN program p ON c.Program_ID = p.Program_ID 
...
<div class="table-responsive">
    <ul class="pagination justify-content-end pagination-md student_pagination">
        ...
        <tbody>
            <?php 
                ...
                while ($obj = $sql -> fetch_object()) {
                    ?>
                    <tr id="<?php echo htmlspecialchars($obj->SR_Code); ?>" class="rows student_table_row_<?php echo htmlspecialchars($obj->SR_Code); ?>">
